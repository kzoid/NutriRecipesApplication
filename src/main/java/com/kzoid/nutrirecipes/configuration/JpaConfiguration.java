package com.kzoid.nutrirecipes.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.kzoid.nutrirecipes.repositories",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[]{"com.kzoid.nutrirecipes.model"});
